...
public class ClassExample1 {
	...
	public static void main(String[] args) {
		...
		// - 객체를 프로그래밍 언어로 표현한 것
		// - 객체의 설계도 
		// - 클래스를 통해만드는 하나의 실제 객체를 인스턴스라고 부릅니다. 
		...
		// - public class는 파일의 이름이기 때문에 그 소스 파일 전체의 주제를 알 수 있는 이름을 짓는 것이 좋다. 
		...
		Student[] kids = new Student[100];   // kids라는 배열을 student 인스턴스 100개 짜리 배열
