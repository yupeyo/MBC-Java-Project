...
public class MethodExample1 {
	// 매서드
			...
			// JAVA에서는 클래스 내부에만 함수를 저으이할 수 있기 때문에 메서드라는 용어를 사용함. 
			 ...
			 *   
			 *   } 
			 *   접근 제한자 : public, default, protect, preivate...
			 *   static : static은 쓰거나 생략이 가능함...
	...
	static void createRabit() {   //매개변수 x, 반환 타입 x   ->4번째 타입 
		...
		System.out.println("===================");
		return; // 1. 함수(메서드)의 종료, 2. 반환값 처리
	}
	// 메시지를 전달하면, 해당 메시지 "***" 값을 양쪽에 붙여주는 문자열을 만드는 메서드...
	// 매개값 전달 : String
	// 반환값 : String
	
	static String makeBanner(String msg) {  //매개 변수 O, 반환값 O
		return "* * *" + msg +"* * *";
	}
