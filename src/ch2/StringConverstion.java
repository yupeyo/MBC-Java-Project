...
public class StringConverstion {
	...
	public static void main(String[] args) {
		...
		System.out.println(str+100);        // str(문자열) + 100 -> 문자열 더하기는 문자로 덧붙이다
		
		// 숫자 문자열은 short로 변환
		short valueShort = Short.parseShort(str);
//		short valueShort2 = Short.parseShort("60000");//java.lang.NumberFormatException: Value out of range. Value:"60000" Radix:10
		// 숫자 문자열을 int로 변환
		...
		// String -> boolean
		String starBoolean = "true";
		boolean valueBoolean = Boolean.parseBoolean(starBoolean);
