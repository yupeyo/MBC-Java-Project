...
public class printing {
	...
	public static void main(String[] args) {
		// 표준 출력... System.out   표준입력 System.in
		// 출력은 화면, 데이터 전송 ...
		...
		// 형식 물자열에서 %와 conversation(변환문자)를 필수로 작성하고, 나머지 생략가능...
		// %[argument_index$][flags][width][.percision]conversation
		//conversation의 종류...
		// %d: 10진수 정수
		// %o: 8진수 정수
		// %x: 16진수 정수
