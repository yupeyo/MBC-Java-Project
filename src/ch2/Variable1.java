...
public class Variable1 {
	...
	public static void main(String[] args) {
		...
		int age;
		age = 100;
		System.out.println(age); //sysout+ [ctal+space] 자동 완성
		System.out.println("입력된 나이는: "+age); //변수 값 사용
		double height = 179.8;
		System.out.println("나의키는 : "+height); 
		float weight = 103.4f;
		...
		System.out.println("x < x && x <20: "+result);
		result = (x < 0 || x > 200);// qustn x는 0보다 작거나 200보다 큰가요? (or)
