 ...
 *  - 보통 메서드를 호출할 때는 메서드 선언부에 지정한 데이터 타입과 일치하는 매개 값을 전달하여 호출합니다. 하지만, 매개변수에 다형성을 적용하면 자식 객체를 전달할 수 있습니다.
 *  
 *  
 * 
 * 
...
public class PolymorphismEx2 {
	...
	public static void main(String[] args) {
		...
		System.out.println("instanceof 결과" + (s instancefo student));
		printPersonInfo(s);
	...
	public static void printPersonInf(Person p) {
