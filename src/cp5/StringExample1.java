...
public class StringExample1 {
	...
	public static void main(String[] args) {
		...
		String hobby = "여행";
		String hobby2 = "여행"; // 문자열 리터럴이 동일할 경우에는 String객체를 공유하게 된다...
		// test = hobby; 대입 후에 test == hobby2와 비교했을 동등 비교가 가능합니다.
		String hobby3 = new String("여행"); // new String("여행")
		String test = hobby;
		
		System.out.println(test == hobby);
		System.out.println(test == hobby2);
		System.out.println(test == hobby3);
		// 문자에서 equals()는 문자열 그 자체를 비교하기 때문에 동등비교가 가능함.
		System.out.println(test.equals(hobby3));
		System.out.println(! test.equals(hobby3));  //문자열 비교할 때는 equals()를 사용하세요.
		
		//문자열 추출
		String str = "자바는 즐거워!";
		//            0 123 45 67
		System.out.println("2번 인덱스 값을 추철 : "+ str.charAt(2)); // 는
		...
		str = "apple/bannana/kiwi/lemon/orange";
		...
		System.out.println("indexOf(\"d\")의 두번째 위치 : " +str.indexOf('d', 6)); 
		...
		int idx = 0;
		str.indexOf("apple");
		System.out.println("첫번째 apple의 인덱스 값 : "+idx); //0 (글자수)
		idx = str.indexOf("apple", idx + 1);
		System.out.println("두번째 apple의 인덱스 값 : "+idx); //11
		idx = str.indexOf("apple", idx + 1);
		System.out.println("세번째 apple의 인덱스 값 : "+idx); //-1
		...
		System.out.println("after1 : " + id_2);
