...
public class IfExample1 {
	 ...
	 * 1. _ (언더바)를 활용해서 두 단어 이상의 이어진 변수 또는 메서드 명을 지정합니다.
	 *   이유? 변수명에서는 "띄어쓰기"를 사용하면 안됨. 
	 *   ex) int plus Result (x) -> int plusResult or int plus_result
	 * 2. 두 단어 이상을 이어붙일 때 변수명 지정시 대문자 활용할 수 있어요. (낙타 표기법- 카멜)
	 *   ex) int plusResult
	 * 3. 변수명 첫글자는 소문자를 사용합니다. 
	...
	public static void main(String[] args) {
		...
		if (a % 3 == 0){ // 3의 배수이면 참...
			...
			if (a % 2 == 0) // 2의배수 혹은 짝수이면 참...
				System.out.println("6의 배수입니다. ");
		}else {
			System.out.println("3의 배ㅔ수 이지만 6의 배수는 아닙니다...");
		}		
